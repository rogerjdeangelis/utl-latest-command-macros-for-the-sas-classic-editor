...
%let pgm=utl-latest-command-macros-for-the-best-editor-ever-created-the-sas-classic-editor;
...
%macro xpy/cmd parmbuff des='Type xpy roger for program banner with large font https://github.com/rogerjdeangelis/utl_program_banners';
